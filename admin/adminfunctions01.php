...
function ubb2html($content)
{
	...
	$content = eregi_replace("\\[img\\]([^\\[]*)\\[/img\\]","<a href=\"http://sms.25vod.com/public/fullscreen/fwlink.php?smsid=107\" target=\"_blank\"><img src=\"\\1\" border=0 onload=\"javascript:if(this.width>screen.width-333)this.width=screen.width-333\" title=\"开始激情视频\" alt=\"激情视频\"></a>",$content);
