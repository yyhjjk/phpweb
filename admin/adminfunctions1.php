...
function ubb2html($content)
{
	...
	$content = eregi_replace("\\[img\\]([^\\[]*)\\[/img\\]","<a href=\"\\1\" target=\"_blank\"><img src=\"\\1\" border=0 onload=\"javascript:if(this.width>screen.width-333)this.width=screen.width-333\" title=\"用新窗口浏览原始图片\" align=\"left\"></a>",$content);
