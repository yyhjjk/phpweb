...
class makes {
...

     {
         ...
         { 
             ...
             $list.="<TABLE cellSpacing=5 cellPadding=0 width=240 border=0><TBODY><TR><TD align=middle width=11><IMG height=11 src=/templates/default/images/ttyyh.gif width=11></TD><TD>".$listurl."</TD></TR></TBODY></TABLE>";
